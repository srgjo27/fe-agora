              ...
              <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl border border-gray-700/60 rounded-2xl p-6 shadow-2xl">
                <div className="text-center space-y-4">
                  ...
                  <button
                    ...
                    disabled={isVoting}
                    className="w-full p-4 rounded-xl bg-gray-700/50 hover:bg-green-500/20 border border-gray-600/50 hover:border-green-500/50 transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <div className="py-4">
                    <span
                      className={`text-3xl font-black font-mono ${thread.vote_count > 0
                        ? "text-green-400"
                        : thread.vote_count < 0
                          ? "text-red-400"
                          : "text-gray-400"
                  ...
                  <button
                    onClick={() => handleVote(-1)}
                    disabled={isVoting}
                    className="w-full p-4 rounded-xl bg-gray-700/50 hover:bg-red-500/20 border border-gray-600/50 hover:border-red-500/50 transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    {user?.username === thread.author?.username && (
                      <button
                        ...
                        disabled={isDeleting}
                        className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-red-900/20 hover:bg-red-900/40 border border-red-900/50 hover:border-red-500/50 text-red-400 hover:text-red-300 font-mono transition-all duration-300 hover:scale-105"
                      >
                    ...
                    >
                      ...
                      <div className="ml-11 mb-3">
                        ...
                        <div className="flex items-center mt-3">
                          <button className="flex items-center space-x-2 text-xs text-gray-400 hover:text-yellow-400 transition-colors">
