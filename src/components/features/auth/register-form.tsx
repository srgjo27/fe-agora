    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label
            htmlFor="username"
            className="block text-sm font-mono font-medium text-green-400 mb-2"
          >
            $ ./username
          </label>
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-300 bg-gray-900/50 backdrop-blur-sm text-white font-mono placeholder-gray-500 ${
              formErrors.username
                ...
                : "border-gray-600/50 focus:border-green-400 focus:ring-green-500/20"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full bg-gradient-to-r from-green-500 to-blue-600 text-gray-900 py-3 px-4 rounded-lg font-mono font-bold hover:from-green-400 hover:to-blue-500 focus:outline-none focus:ring-4 focus:ring-green-500/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-green-500/25 hover:shadow-xl hover:shadow-green-500/40 transform hover:-translate-y-0.5 border border-green-400/30"
        >
          {isLoading ? (
